...
import { FileQuestion, type LucideIcon, Target } from 'lucide-react'
            ...
            <div className="mx-auto max-w-2xl px-6 lg:max-w-5xl">
                <div className="mx-auto grid gap-4 lg:grid-cols-2">
                    <FeatureCard>
                        <CardHeader className="pb-3">
                            <CardHeading
                                icon={FileQuestion}
                                title="QCM corriges"
                                description="2000+ questions avec explications detaillees pour ancrer chaque notion."
                            />
                        </CardHeader>
                        ...
                        <div className="relative mb-6 border-t border-dashed sm:mb-0">
                            ...
                            <div className="aspect-[76/59] p-1 px-6">
                                <DualModeImage
                                    darkSrc="/landing/qcm-correction.webp"
                                    lightSrc="/landing/qcm-correction.webp"
                                    alt="Exemple de QCM corrige"
                                    width={1207}
                                    height={929}
                                />
                            </div>
                    ...
                    <FeatureCard>
                        <CardHeader className="pb-3">
                            <CardHeading
                                ...
                                description="Vois tes points forts et tes lacunes, chapitre par chapitre."
                            />
                        </CardHeader>
                        ...
                        <CardContent>
                            <div className="relative mb-6 sm:mb-0">
                                ...
                                <div className="aspect-[76/59] border">
                                    <DualModeImage
                                        darkSrc="/landing/progression-dashboard.webp"
                                        lightSrc="/landing/progression-dashboard.webp"
                                        alt="Tableau de progression"
                                        width={1207}
                                        height={929}
                                    />
                                </div>
                    ...
                    <FeatureCard className="p-6 lg:col-span-2">
                        <p className="mx-auto my-6 max-w-md text-balance text-center text-2xl font-semibold">Revision espacee pour memoriser sans bachoter.</p>
